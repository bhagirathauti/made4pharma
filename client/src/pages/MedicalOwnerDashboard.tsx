      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Medical Owner Dashboard</h1>
              <p className="text-gray-600 mt-2">Manage your pharmacy operations and inventory</p>
            </div>
